...
function ProjectOperations() {
  ...
  function clearallProjectDataList() {
    let data_list = document.querySelector(
      "#project-selection-input-1"
    ).children;
    for (let i = data_list.length - 1; i > 1; i--) {
      data_list.item(i).remove();
    }

    let data_list2 = document.querySelector(
      "#project-selection-input-2"
    ).children;
