...
function taskOperations() {
  ...
  function getupdatedvaluesTask() {
    if (
      document
        .querySelector("#update-task-container")
        .querySelector("#task-title-input").value == "" ||
      document
        .querySelector("#update-task-container")
        .querySelector("#task-description-input").value == "" ||
      document
        .querySelector("#update-task-container")
        .querySelector("#task-due-input").value == "" ||
      document
        .querySelector("#update-task-container")
        .querySelector("#task-priority-input").value == "" ||
      document
        .querySelector("#update-task-container")
        .querySelector("#project-selection-input-2").value == ""
    ) {
      return false;
    } else {
      let title = document
  ...
  function updatevaluesTask(id) {
    ...
    let duedate = document
      .getElementById(id)
      .querySelector("#duedate").textContent;
    let priority = document
      .getElementById(id)
    ...
    document
      .querySelector("#update-task-container")
      .querySelector("#task-title-input").value = title;
    document
      .querySelector("#update-task-container")
      .querySelector("#task-description-input").value = description;
    document
      .querySelector("#update-task-container")
      .querySelector("#task-due-input").value = duedate;
    document
      .querySelector("#update-task-container")
      .querySelector("#task-priority-input").value = priority;
    document
      .querySelector("#update-task-container")
      .querySelector("#project-selection-input-2").value = project;
  }
    ...
    if (document.querySelectorAll(".updateTaskBtn")) {
      document.querySelectorAll(".updateTaskBtn").forEach((button) => {
        button.addEventListener("click", (event) => {
          ...
          document
            .querySelector("#update-submit-task")
  ...
  function updateTaskElement(task_number) {
    let object = JSON.parse(localStorage.getItem(`${task_number}`));
    document
      .querySelector(`#task-number-${task_number}`)
      .querySelector("#title").textContent = object.title;
    document
      .querySelector(`#task-number-${task_number}`)
      .querySelector("#description").textContent = object.description;
    document
      .querySelector(`#task-number-${task_number}`)
      .querySelector("#duedate").textContent = object.duedate;
    document
      .querySelector(`#task-number-${task_number}`)
      .querySelector("#priority").textContent = object.priority;
  }
  ...
  (function cancelBtnClick() {
    ...
    document
      .querySelector("#update-cancel-task")
      .addEventListener("click", (event) => {
        hideUpdateTaskContainer();
      });
  })();
  ...
  function checkifTaskDone() {
    document.querySelectorAll(".check").forEach((button) =>
      button.addEventListener("click", (event) => {
        ...
        document.getElementById(`task-number-${num}`).style[
          "background-color"
        ] = "cyan";
